...
export const translations = {
  en: {
    ...
    projects: {
      ...
      loadMore: "Load More",
      desc1: "An AI-based automated video processing application with asynchronous computing architecture. Integrates FFmpeg with Python's asynchronous subprocesses (asyncio) on the backend, alongside efficiently optimized data streaming and memory management systems.",
    ...
    experience: {
      ...
      desc1: "Actively designing and developing an end-to-end e-learning platform based on Laravel and Vue.js. Taking full responsibility for implementing core features, ranging from course management architecture and payment gateway integration (Midtrans) to secure video distribution systems via AWS S3. Currently focusing on iterating modern feature development such as Google OAuth and interactive learning progress tracking.",
      role2: "Software Engineer",
      desc2: "Successfully designed and deployed an AI-based automated video editing platform from concept to release. Built a robust architecture using FastAPI (Python) and FFmpeg for advanced video processing, along with a responsive interface using React.js and TypeScript. Implemented secure authentication systems, transaction credit management, and optimized data streaming efficiently.",
  ...
  id: {
    ...
    projects: {
      ...
      loadMore: "Muat Lebih",
      desc1: "Aplikasi pemrosesan video otomatis berbasis AI dengan arsitektur komputasi asinkron. Mengintegrasikan FFmpeg dengan subprocess asinkron Python (asyncio) di backend, serta sistem aliran data dan manajemen memori yang dioptimalkan secara efisien.",
    ...
    experience: {
      ...
      present: "Sekarang",
      role1: "Full-Stack Software Engineer",
      desc1: "Secara aktif merancang dan mengembangkan platform e-learning end-to-end berbasis Laravel dan Vue.js. Bertanggung jawab penuh atas implementasi fitur inti, mulai dari arsitektur manajemen kursus, integrasi payment gateway (Midtrans), hingga sistem distribusi video aman via AWS S3. Saat ini berfokus pada iterasi pengembangan fitur modern seperti Google OAuth dan pelacakan progres belajar interaktif.",
      role2: "Software Engineer",
      desc2: "Berhasil merancang dan mendeploy platform video editing otomatis berbasis AI dari tahap konsep hingga rilis. Membangun arsitektur tangguh menggunakan FastAPI (Python) dan FFmpeg untuk pemrosesan video tingkat lanjut, serta antarmuka responsif dengan React.js dan TypeScript. Mengimplementasikan sistem autentikasi aman, manajemen kredit transaksi, dan optimasi aliran data secara efisien.",
      role3: "Web Backend Developer",
